...
if menina1Dupla1 == menina1Dupla2 or menina1Dupla2 == menina2Dupla1:
    print("empate")

elif menina1Dupla1 > menina1Dupla2 and menina1Dupla1 >= menina2Dupla1 and menina1Dupla1 > menina2Dupla2:
    print(menina1Dupla1)
